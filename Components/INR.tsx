...
const INR = (card) => {
    ...
    const url2="https://api.coingecko.com/api/v3/coins/markets?vs_currency=inr&order=market_cap_desc&per_page=5&page=1&sparkline=false&price_change_percentage=7d"
            ...
            <Flex justifyContent="space-around" px="1" >
                <Box minW="4" >
                        <FormControl id="currency">
                            ...
                            <Select onClick={() => router.push('/INR')} >
